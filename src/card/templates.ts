  ...
  return shell('💡 使用帮助', [
    divMd(
      [
        ...
        '- `/new worktree <name> [backend]` — 创建 git worktree，并新建绑定群聊',
        ...
        '- `/doc bind <doc-url|token>` — 在群里绑定到当前群 backend/session',
        '- `/doc bind <doc-url|token> <backend|default> <session-id>` — 显式指定云文档 backend/session',
